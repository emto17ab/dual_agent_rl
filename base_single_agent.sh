...
python main_a2c.py --reward_scalar 2000 --critic_warmup_episodes 50 --mode ${MODE} --city "washington_dc" --q_lr 0.0005 --p_lr 0.0002 --actor_clip 1000 --critic_clip 1000 --max_episodes 150000 --observe_od_prices --checkpoint_path single_agent_washington_dc_paper_mode${MODE}
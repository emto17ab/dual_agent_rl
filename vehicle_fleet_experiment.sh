...
python main_a2c_multi_agent.py --reward_scalar 2000 --critic_warmup_episodes 50 --mode $MODE --city "nyc_man_south" --q_lr 0.0006 --p_lr 0.0002 --actor_clip 1000 --critic_clip 1000 --max_episodes 100000 --observe_od_prices --no_share_info --total_vehicles $CARS --checkpoint_path dual_nyc_man_south_cars_${CARS}_v2_mode${MODE}
